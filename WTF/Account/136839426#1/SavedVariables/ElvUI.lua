	...
	["profiles"] = {
		["Default"] = {
			...
			["movers"] = {
				...
				["BuffsMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,154,-2",
				["MawBuffsBelowMinimapMover"] = "TOPRIGHT,UIParent,TOPRIGHT,-634,-327",
				["BossButton"] = "BOTTOM,UIParent,BOTTOM,0,135",
				["LootFrameMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,417,-186",
				["ZoneAbility"] = "BOTTOM,UIParent,BOTTOM,416,207",
				["SocialMenuMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,4,-187",
				["PowerBarContainerMover"] = "TOP,ElvUIParent,TOP,0,-75",
				["ElvUF_PetCastbarMover"] = "TOPLEFT,ElvUF_Pet,BOTTOMLEFT,0,-1",
				["VehicleSeatMover"] = "TOPLEFT,UIParent,TOPLEFT,4,-656",
				["BossBannerMover"] = "TOP,ElvUIParent,TOP,0,-125",
				["ElvUF_TargetTargetMover"] = "BOTTOM,ElvUIParent,BOTTOM,259,398",
				["LossControlMover"] = "BOTTOM,ElvUIParent,BOTTOM,-1,507",
				["MirrorTimer1Mover"] = "TOP,ElvUIParent,TOP,-1,-96",
				["ElvAB_4"] = "RIGHT,ElvUIParent,RIGHT,-4,0",
				["AzeriteBarMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-2,-245",
				["ReputationBarMover"] = "TOP,UIParent,TOP,190,-411",
				["ObjectiveFrameMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,81,-153",
				["MirrorTimer2Mover"] = "TOP,MirrorTimer1,BOTTOM,0,0",
				["ShiftAB"] = "BOTTOMRIGHT,UIParent,BOTTOMRIGHT,-400,273",
				["ArenaHeaderMover"] = "BOTTOMRIGHT,ElvUIParent,RIGHT,-105,-165",
				["ElvUIBagMover"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-312,1",
				["ElvAB_7"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-4,298",
				["RightChatMover"] = "BOTTOMLEFT,UIParent,BOTTOMLEFT,4,24",
				["ElvUF_AssistMover"] = "TOP,UIParent,TOP,-362,-688",
				["TopCenterContainerMover"] = "TOP,ElvUIParent,TOP,0,-30",
				["ThreatBarMover"] = "BOTTOMRIGHT,UIParent,BOTTOMRIGHT,-23,304",
				["ElvUF_PlayerCastbarMover"] = "BOTTOM,ElvUIParent,BOTTOM,-336,427",
				["ElvUF_RaidMover"] = "BOTTOMLEFT,UIParent,BOTTOMLEFT,109,347",
				...
				["ElvAB_2"] = "BOTTOM,ElvUIParent,BOTTOM,0,1",
				["BelowMinimapContainerMover"] = "TOPRIGHT,UIParent,TOPRIGHT,-434,-287",
				["ElvUIBankMover"] = "BOTTOMLEFT,LeftChatPanel,BOTTOMLEFT,0,26",
				["ElvUF_PetMover"] = "BOTTOM,ElvUIParent,BOTTOM,-259,398",
				["ElvUF_TargetCastbarMover"] = "BOTTOM,ElvUIParent,BOTTOM,335,427",
				["ElvUF_PlayerMover"] = "BOTTOM,UIParent,BOTTOM,-336,427",
				["ElvAB_3"] = "BOTTOM,ElvUIParent,BOTTOM,-1,139",
				["ElvAB_5"] = "BOTTOM,ElvUIParent,BOTTOM,-279,4",
				["VehicleLeaveButton"] = "BOTTOM,UIParent,BOTTOM,-245,42",
				["TooltipMover"] = "BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-1,141",
				["TalkingHeadFrameMover"] = "TOP,UIParent,TOP,105,-600",
				["DurabilityFrameMover"] = "TOPLEFT,UIParent,TOPLEFT,160,-682",
				...
				["ElvUF_PartyMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-2,-2",
				["AlertFrameMover"] = "TOP,ElvUIParent,TOP,0,-20",
				["DebuffsMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,154,-95",
				["MinimapMover"] = "TOPLEFT,ElvUIParent,TOPLEFT,2,-2",
			},
			["convertPages"] = true,
			["tooltip"] = {
				["healthBar"] = {
					...
					["player"] = {
						...
						["customTexts"] = {
							...
							["PlayerPower"] = {
								["attachTextTo"] = "Health",
								["xOffset"] = 0,
								["text_format"] = "[classpower:current:shortvalue][  >power:current:shortvalue]",
								["yOffset"] = -12,
								["font"] = "Expressway",
								["justifyH"] = "RIGHT",
								["fontOutline"] = "OUTLINE",
